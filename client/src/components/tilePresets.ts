...
export const TILE_PRESETS: TilePreset[] = [
  ...
  // ─── Elite Dangerous ────────────────────────────────
  { key: 'elite-system-label', category: 'Elite Dangerous', label: 'ED: Current system', hint: 'Dynamic label showing your current star system', iconName: 'rocket',
    keywords: 'elite dangerous system star current label',
    create: (id) => ({ kind: 'button', id, label: '{elite.system}', icon: 'rocket', action: { type: 'url', url: 'https://inara.cz/elite/starsystem/?search=' } }) },
  { key: 'elite-ship-label', category: 'Elite Dangerous', label: 'ED: Ship name', hint: 'Dynamic label showing your active ship', iconName: 'rocket',
    keywords: 'elite dangerous ship name label',
    create: (id) => ({ kind: 'button', id, label: '{elite.shipName}', icon: 'rocket', action: { type: 'url', url: 'https://coriolis.io' } }) },
  { key: 'elite-credits-label', category: 'Elite Dangerous', label: 'ED: Credit balance', iconName: 'zap',
    keywords: 'elite dangerous credits balance cr money label',
    create: (id) => ({ kind: 'button', id, label: '{elite.credits}', icon: 'zap', action: { type: 'url', url: 'https://inara.cz' } }) },
  { key: 'elite-status-label', category: 'Elite Dangerous', label: 'ED: Flight state', hint: 'docked / landed / supercruise / flight', iconName: 'rocket',
    keywords: 'elite dangerous status flight docked supercruise state label',
    create: (id) => ({ kind: 'button', id, label: '{elite.status}', icon: 'rocket', action: { type: 'url', url: 'https://inara.cz' } }) },
  { key: 'elite-fuel-chart', category: 'Elite Dangerous', label: 'ED: Fuel % sparkline', hint: 'Live chart of main fuel tank percentage. Turns amber below 25 % (game warning), red below 10 %.', iconName: 'zap',
    keywords: 'elite dangerous fuel tank chart sparkline percent warning',
    create: (id) => ({
      kind: 'chart', id, label: 'Fuel', source: 'elite.fuelPercent',
      mode: 'value', min: 0, max: 100,
      // Matches Elite's in-game fuel warning — amber at 25 %, red at 10 %.
      thresholds: [
        { atOrBelow: 25, color: '#f59e0b' },
        { atOrBelow: 10, color: '#ef4444' },
      ],
    }) },
  { key: 'elite-cargo-chart', category: 'Elite Dangerous', label: 'ED: Cargo tons sparkline', iconName: 'zap',
    keywords: 'elite dangerous cargo tons chart sparkline',
    create: (id) => ({ kind: 'chart', id, label: 'Cargo', source: 'elite.cargoTons', mode: 'value', min: 0 }) },
  { key: 'elite-mission-count', category: 'Elite Dangerous', label: 'ED: Mission count', hint: 'Number of active missions', iconName: 'clipboard',
    keywords: 'elite dangerous mission count active label',
    create: (id) => ({ kind: 'button', id, label: '{elite.missionCount} missions', icon: 'clipboard', action: { type: 'url', url: 'https://inara.cz/elite/cmdr-missions/' } }) },
  { key: 'elite-mission-reward', category: 'Elite Dangerous', label: 'ED: Pending mission rewards', hint: 'Sum of active-mission rewards', iconName: 'zap',
    keywords: 'elite dangerous mission reward pending credits label',
    create: (id) => ({ kind: 'button', id, label: '{elite.missionReward}', icon: 'zap', action: { type: 'url', url: 'https://inara.cz/elite/cmdr-missions/' } }) },
  { key: 'elite-next-expiry', category: 'Elite Dangerous', label: 'ED: Next mission expiry', hint: 'Countdown to soonest expiring mission', iconName: 'clock',
    keywords: 'elite dangerous mission expiry countdown timer label',
    create: (id) => ({ kind: 'button', id, label: '{elite.nextExpiry}', icon: 'clock', action: { type: 'url', url: 'https://inara.cz/elite/cmdr-missions/' } }) },
  { key: 'elite-mission-count-chart', category: 'Elite Dangerous', label: 'ED: Mission count sparkline', iconName: 'clipboard',
    keywords: 'elite dangerous mission count chart sparkline over time',
    create: (id) => ({ kind: 'chart', id, label: 'Missions', source: 'elite.missionCount', mode: 'value', min: 0 }) },
  { key: 'elite-mission-reward-chart', category: 'Elite Dangerous', label: 'ED: Pending reward sparkline', iconName: 'zap',
    keywords: 'elite dangerous mission reward chart sparkline over time',
    create: (id) => ({ kind: 'chart', id, label: 'Rewards', source: 'elite.missionReward', mode: 'value', min: 0 }) },
