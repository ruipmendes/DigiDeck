...
const VALID_ACTION_TYPES = new Set(['hotkey', 'text', 'launch', 'url', 'script', 'volume', 'mic', 'app-audio', 'obs', 'streamlabs', 'twitch', 'twitch-streamer', 'kick', 'kick-streamer', 'discord', 'spotify', 'hue', 'homeassistant', 'openrgb', 'goto-page', 'wait']);
